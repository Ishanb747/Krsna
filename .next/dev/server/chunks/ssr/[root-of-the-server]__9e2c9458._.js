...
function SignupPage() {
    ...
    const handleSignup = async (e)=>{
        ...
        setError("");
        try {
            const { createUserWithEmailAndPassword } = await __turbopack_context__.A("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript, async loader)");
            const { auth } = await __turbopack_context__.A("[project]/src/lib/firebase.ts [app-ssr] (ecmascript, async loader)");
