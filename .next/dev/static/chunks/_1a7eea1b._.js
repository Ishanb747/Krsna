...
function useTodos() {
    ...
    const addTodo = async (text, priority = "medium", habitId, dueDate, tags = [], description = "")=>{
        if (!user) return;
        try {
    ...
    const updateTodo = async (id, updates)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "todos", id), updates);
        } catch (error) {
...
function DashboardPage() {
    _s();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const { habits } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useHabits$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHabits"])();
    const { todos, addTodo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTodos$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTodos"])();
    const { entries } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useJournal$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useJournal"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            ...
            const todayTimestamp = today.getTime();
            habits.forEach({
                "DashboardPage.useEffect": (habit)=>{
                    // Check if this habit is already in today's todos using habitId
                    const habitTodoExists = todos.some({
                        "DashboardPage.useEffect.habitTodoExists": (todo)=>todo.habitId === habit.id && todo.createdAt >= todayTimestamp
                    }["DashboardPage.useEffect.habitTodoExists"]);
                    if (!habitTodoExists) {
...
_s(DashboardPage, "LX3QXBoQgMZ3UmHTDxleHIC48Kg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=_1a7eea1b._.js.map